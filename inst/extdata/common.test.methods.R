...
compute.reconstructions <- function(x, Ls, groups,
                                    ...
                                    svd.method = c("eigen", "propack", "nutrlan", "svd", "rspectra", "primme", "irlba", "rsvd"),
...
make.test.data <- function(what = c("reconstruct", "rforecast", "vforecast"),
                           ...
                           neig = NULL,
                           tolerance = 1e-7,
                           svd.methods = c("eigen", "propack", "svd", "nutrlan", "rspectra", "primme", "irlba", "rsvd"),
                           svd.methods.forecast = c("eigen", "propack", "svd", "nutrlan", "rspectra", "primme", "irlba", "rsvd"),
                           column.projector = "none",
                           row.projector = "none",
                           ...) {
  ...
  svd.methods <- lapply(svd.methods, function(svd.methods.v) sapply(svd.methods.v, match.arg, choices = c("eigen", "propack", "svd", "nutrlan", "rspectra", "primme", "irlba", "rsvd")))
  svd.methods.forecast <- lapply(svd.methods.forecast, function(svd.methods.v) sapply(svd.methods.v, match.arg, choices = c("eigen", "propack", "svd", "nutrlan", "rspectra", "primme", "irlba", "rsvd")))
